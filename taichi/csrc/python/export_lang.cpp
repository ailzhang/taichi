...
#include "taichi/csrc/ir/frontend.h"
...
#include "taichi/csrc/program/snode_rw_accessors_bank.h"
#include "taichi/csrc/common/interface.h"
#include "taichi/csrc/python/export.h"
#include "taichi/csrc/gui/gui.h"
#include "taichi/csrc/math/svd.h"
#include "taichi/csrc/util/statistics.h"
#include "taichi/csrc/util/action_recorder.h"
#include "taichi/csrc/system/timeline.h"
#include "taichi/csrc/python/snode_registry.h"
...
#include "taichi/csrc/inc/archs.inc.h"
#undef PER_ARCH
      .export_values();
...
#define PER_TYPE(x)                                                  \
  m.attr(("DataType_" + data_type_name(PrimitiveType::x)).c_str()) = \
      PrimitiveType::x;
#include "taichi/csrc/inc/data_type.inc.h"
#undef PER_TYPE
