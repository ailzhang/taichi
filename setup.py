...
print(data_files)
packages = find_packages('python') + ['taichi.examples']
print(packages)
    ...
    def prepare_package(self):
        ...
        if get_os_name() != 'osx':
            ...
            shutil.copy(libdevice_path,
                        os.path.join(target_lib_dir, 'slim_libdevice.10.bc'))
        ...
        for f in os.listdir(llvm_runtime_dir):
            if f.startswith('runtime_') and f.endswith('.bc'):
                ...
                shutil.copy(os.path.join(llvm_runtime_dir, f), target_lib_dir)
